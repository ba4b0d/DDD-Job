...
export default function Products() {
  ...
  const handleAddProduct = async (data) => {
    const payload = {
      ...
      dimension_x: data.dimension_x ? parseFloat(data.dimension_x) : null,
      dimension_y: data.dimension_y ? parseFloat(data.dimension_y) : null,
      dimension_z: data.dimension_z ? parseFloat(data.dimension_z) : null,
